  ...
  return (
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="i mb-12 flex items-center gap-5">
          <input
...
export async function action({ request }) {
  ...
  const orderPrice = cart.reduce((sum, cur) => sum + cur.totalPrice, 0);
  const isPriority = data.priority === "true";
  const priorityPrice = isPriority ? Math.round(orderPrice * 0.2) : 0;
  const order = {
    ...data,
    cart,
    priority: isPriority,
